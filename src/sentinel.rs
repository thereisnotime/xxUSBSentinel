...
pub struct SharedState {
    ...
    /// Seconds to hold the fake screen before shutting down.
...
impl SharedState {
    pub fn new_from_config(cfg: &Config) -> Arc<Mutex<Self>> {
        Arc::new(Mutex::new(Self {
            ...
            bsod_delay_secs:   cfg.bsod_delay_secs,
        }))
    }
}
...
pub enum GuiEvent {
    ...
    ShutdownTriggered { wipe_swap: bool, wipe_hiberfil: bool, fake_bsod: bool, bsod_style: String, bsod_delay_secs: u32 },
}
